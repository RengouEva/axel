  ...
  return (
    <div className="p-4 lg:p-8 space-y-8">
      <div>
        ...
        <p className="text-[var(--text-secondary)] text-sm">Gestion des transactions</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 bg-[var(--bg-card)] rounded-2xl border border-[var(--border)]">
        <div className="w-20 h-20 rounded-2xl bg-[var(--text-link)]/10 flex items-center justify-center mb-6">
          <Wallet className="w-10 h-10 text-[var(--text-link)]" />
        </div>
        <h2 className="text-xl font-bold text-white mb-2">Module paiement en cours d'intégration</h2>
        <p className="text-[var(--text-secondary)] text-sm max-w-md text-center">
          Le système de gestion des paiements est actuellement en développement.
